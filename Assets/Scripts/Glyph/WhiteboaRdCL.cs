...
public class WhiteboaRdCL : AbstractFont {
	...
	private double[] charoffset = {
		...
		0.15000000, 0.19666667, 0.19666667,	// Ä, Ö, Ü
	...
	private double[] charscale = {
		...
		0.70000000, 0.60666667, 0.60666667, // Ä, Ö, Ü
	...
	private int index(char c){
		...
		switch(c){
		case 'Ä': return 2*26+10;
		case 'Ö': return 2*26+11;
		case 'Ü': return 2*26+12;
		case 'ä': return 2*26+13;
